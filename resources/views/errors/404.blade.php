    ...
    <div class="bg-white w-full">
        <div class="flex flex-col h-screen">
            <div class="m-auto text-center">
                ...
                <h5 class="text-blue-600 font-bold uppercase mt-14">404 Page</h5>
                <h1 class="font-black text-4xl mt-2">Page Not Found :(</h1>
                <p class="text-gray-500 text-lg mt-2">Sorry, we couldn't find the page you're looking for.
                </p>
