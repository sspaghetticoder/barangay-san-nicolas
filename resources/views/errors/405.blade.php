    ...
    <div class="bg-white w-full">
        <div class="flex flex-col h-screen">
            <div class="m-auto text-center">
                ...
                <h5 class="text-blue-600 font-bold uppercase mt-14">405 Page</h5>
                <h1 class="font-black text-4xl mt-2">Oops! An Error Occurred</h1>
                <p class="text-gray-500 text-lg mt-2">Something is broken. Make sure to login first. Sorry for any inconvenience caused.
                </p>
